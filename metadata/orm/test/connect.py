...
class TestConnections(TestCase):
    ...
    def test_db_connect_and_fail(self):
        ...
        try:
            ...
            self.assertEqual('unable to open database file', str(ex))

    @httpretty.activate
    def test_create_tables(self):
        """
        Test create tables this is a combination of try_es_connect and
        ...
        for orm_cls in ORM_OBJECTS:
            ...
            es_mapping_url = "%s/_mapping/%s"%(es_url, class_name)
