...
from pacifica.metadata.orm.test.test_users import SAMPLE_USER_HASH as SAMPLE_SUBMITTER_HASH
from pacifica.metadata.orm.test.test_users import TestUsers
...
from pacifica.metadata.orm.test.test_instruments import SAMPLE_INSTRUMENT_HASH, TestInstruments
